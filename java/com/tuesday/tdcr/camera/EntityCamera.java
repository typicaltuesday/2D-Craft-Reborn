package com.tuesday.tdcr.camera;
...
public class EntityCamera extends EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public EntityCamera(Minecraft mc, IResourceManager manager)
    {
    ...
    private void orientCamera(float p_78467_1_)
    {
        ...
        GL11.glTranslatef(0.0F, 0.0F, -this.thirdPersonDistance);
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                catch (Throwable throwable)
                {
                    ...
                    crashreportcategory.addCrashSectionCallable("Screen name", new Callable()
                    {
                        ...
                        public String call()
                        {
                            return EntityCamera.this.mc.currentScreen.getClass().getCanonicalName();
                        }
                    });
